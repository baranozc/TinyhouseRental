...
namespace MyProject.Forms
{
    public partial class ImageViewerForm : Form
    {
        ...
        private void LoadImage(string imagePath)
        {
            ...
            {
                MessageBox.Show("We can't find image file : " + imagePath, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                pictureBox.Image = null; // Görseli temizle
                _isAnimatedGif = false;
                lblImageIndex.Text = "Error";
            ...
            {
                MessageBox.Show($"There's an error while uploading image : {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
